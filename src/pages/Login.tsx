    ...
    <div className="flex min-h-screen bg-background relative overflow-hidden flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex flex-col justify-center items-center w-1/2 p-12 bg-muted/20 relative z-10">
        <div className="max-w-md w-full text-center space-y-6">
          <div className="flex justify-center mb-8">
            <div className="flex h-24 w-24 items-center justify-center rounded-3xl bg-primary text-primary-foreground shadow-sm">
              <Briefcase size={48} />
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-12 relative z-10 w-full lg:w-1/2">
        <div className="w-full max-w-sm space-y-8 mt-12 lg:mt-0">
          ...
          <div className="bg-card border-none lg:border lg:border-border shadow-none lg:shadow-sm rounded-3xl p-0 sm:p-8 space-y-6">
            <button
                onClick={loginWithGoogle}
                className="flex w-full items-center justify-center gap-3 rounded-2xl border border-border bg-background hover:bg-muted px-6 py-4 text-sm font-bold text-foreground shadow-sm transition-all active:scale-95 touch-target hover:border-border"
            >
            ...
            <div className="relative flex items-center justify-center">
                <span className="absolute bg-card px-3 text-[10px] font-bold tracking-wider text-muted-foreground uppercase z-10">{t("or")}</span>
            ...
            >
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full rounded-2xl border border-border bg-background px-4 py-3.5 text-sm font-semibold text-foreground focus:border-primary focus:outline-none transition-colors"
                    />
                </div>
                )}
                <div>
                ...
                className="mt-2 w-full rounded-2xl bg-primary px-4 py-4 text-sm font-bold text-primary-foreground shadow-sm transition-all active:scale-95 disabled:opacity-70 disabled:pointer-events-none"
                >
